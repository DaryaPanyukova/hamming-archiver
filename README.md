...
Реализация помехоустойчивого архиватора файлов без сжатия **HamArc**. Для помехоустойчивого кодирования используются [Коды Хэмминга](https://en.wikipedia.org/wiki/Hamming_code).
